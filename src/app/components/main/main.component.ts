...
export class MainComponent implements OnInit {
  ...
  //send the url list main service function that send to the backend and generates the endpoints
  generateEndpoints() {
    console.log('criando arquivos de download no servidor da api');
    this.mainService.generateEndpoints(this.original_urls_list);
  }
